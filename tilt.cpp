...
int main()
{
	...
	//PCL_ICP(); // Run ICP on the pointclouds
...
void Load_PCDFile(void) {
	...
	viewer->addPointCloud<pcl::PointXYZRGB>(p_cloud[i - 1]);
...
//	icp.setInputSource(p_cloud[1]);
//	icp.setInputTarget(p_cloud[0]);
