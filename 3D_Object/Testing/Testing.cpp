...
// Progressive Morphological Segmentation
...
cloud_pointer bkg_frg(cloud_pointer& cloud);
...
cloud_pointer bkg_frg(cloud_pointer& cloud) {
	...
	//cout << "Enter the cluster search radius:\t";
	//cin >> radius;
	outrem.setRadiusSearch(radius);
	//cout << "\nEnter the min no. of points to be included in cluster:\t";
	//cin >> pointcount;
	outrem.setMinNeighborsInRadius(pointcount);
	// apply filter
...
int PCL_ICP(cloud_pointer& cloud1, cloud_pointer& cloud2)
{
	...
	// Running Progressive Morphological Segmentation
	bkg_frg(cloud1);
	bkg_frg(cloud2);
	...
	//cout << "\nInput cloud translated by +6cm to optimize ICP";
	...
	if (icp.hasConverged())
	{
		cout << "\n Final transformation matrix wrt initial position is : \n" << icp.getFinalTransformation() << endl;
		...
		cout << "\nTranslational Elements:       x           y           z " << endl;
		cout << "                          " << x << "  " << y << "  " << z << endl;
		cout << "\nRotational Elements:       Roll        Pitch        Yaw " << endl;
